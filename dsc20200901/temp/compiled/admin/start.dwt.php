            ...
            <div class="contentWarp">
                ...
                <div class="contentWarp_item clearfix">
                    ...
                    <div class="section_order_select">
                        <ul>
                            <li>
                                <a href="javascript:void(0);" data-url="order.php?act=list&composite_status=<?php echo $this->_var['status']['unconfirmed']; ?>&source=start" data-param="menushopping|02_order_list" ectype="iframeHref">
                                    <i class="ice ice_w"></i>
                            ...
                            <li>
                                <a href="javascript:void(0);" data-url="order.php?act=list&composite_status=<?php echo $this->_var['status']['await_pay']; ?>&source=start" data-param="menushopping|02_order_list" ectype="iframeHref">
                                    <i class="ice ice_d"></i>
                            ...
                            <li>
                                <a href="javascript:void(0);" data-url="order.php?act=list&composite_status=<?php echo $this->_var['status']['await_ship']; ?>&source=start" data-param="menushopping|02_order_list" ectype="iframeHref">
                                    <i class="ice ice_n"></i>
                            ...
                            <li>
                                <a href="javascript:void(0);" data-url="order.php?act=list&composite_status=<?php echo $this->_var['status']['finished']; ?>&source=start" data-param="menushopping|02_order_list" ectype="iframeHref">
                                    <i class="ice ice_f"></i>
                            ...
                            <li>
                                <a href="javascript:void(0);" data-url="user_account.php?act=list&process_type=1&is_paid=1" data-param="menuplatform|09_user_account" ectype="iframeHref">
                                    <i class="ice ice_b"></i>
                    ...
                    <div class="sc_warp">
                        ...
                        <div class="item_section">
                            ...
                            <div class="section_body">
                                ...
                                <dl>
                                	<dt>大商创交流群：</dt>
                                    <dd>(群二)479071433&nbsp;&nbsp;(群三)320978893&nbsp;&nbsp;(群四)530128443&nbsp;&nbsp;(群五)549712434</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
