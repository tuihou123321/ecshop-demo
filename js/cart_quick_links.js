jQuery(function($){
	...
	popTmpl = '<a href="javascript:;" class="ibar_closebtn" title="閉じる"></a><div class="ibar_plugin_title"><h3>ショッピングカート</h3></div><div class="pop_panel"><%=content%></div><div class="arrow"><i></i></div><div class="fix_bg"></div>',
