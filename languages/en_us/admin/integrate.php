...
$_LANG['ucenter_notice_db_host'] = 'Can be local can also be a remote database server, if instead of the default MySQL port 3307, please fill out the following form: 127.0.0.1:6033';
