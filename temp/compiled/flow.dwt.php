                                    ...
                                    <div class="item-item" ectype="item" data-recid="<?php echo $this->_var['goods']['rec_id']; ?>">
                                        <div class="item-form">
                                            <div class="cell s-checkbox">
                                                <div class="cart-checkbox" ectype="ckList">
                                                    <input type="checkbox" id="checkItem_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['rec_id']; ?>" name="checkItem" class="ui-checkbox" ectype="ckGoods" />
                                ...
                                <div class="item_value" ectype="regionLinkage">
                                    <dl class="mod-select mod-select-small" ectype="smartdropdown" id="selProvinces">
                                        ...
                                        <dd ectype="layer">
                                            ...
                                            <?php $_from = $this->_var['provinces']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_18935000_1642001635');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_18935000_1642001635']):
?>
                                            <div class="option" data-value="<?php echo $this->_var['province_0_18935000_1642001635']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_18935000_1642001635']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_18935000_1642001635']['region_name']; ?></div>
                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                        </dd>
                                    </dl>
