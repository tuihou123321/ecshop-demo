...
<div class="side-menu">
	<dl>
		...
		<dd>
			...
			<p<?php if ($this->_var['action'] == 'wholesale_buy' || $this->_var['action'] == 'return_detail'): ?> class="current"<?php endif; ?>><a href="user.php?act=wholesale_buy" target="_self">我的采购单</a></p>
			
			<p<?php if ($this->_var['action'] == 'wholesale_purchase' || $this->_var['action'] == 'purchase_info' || $this->_var['action'] == 'purchase_edit' || $this->_var['action'] == 'purchase_delete'): ?> class="current"<?php endif; ?>><a href="user.php?act=wholesale_purchase" target="_self">我的求购单</a></p>
